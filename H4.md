...
* Siirryin hakemistoon ja muokkasin init.sls tiedostoon tarvitsemani asetukset komennoilla `cd /srv/salt/testiapache/` ja `sudoedit init.sls`:

![image](https://github.com/user-attachments/assets/77a2ae1d-8149-40a0-94d4-e6d05186ecb7)
